...
class NPC(Character):
    ...
    def __init__(self, name: str = "NPC", position: Vector2 = Vector2(0, 0), max_hp: float = 100.0, decision_type: str = 'fsm'):
        """初始化NPC
        ...
        Args:
            ...
            position: NPC位置
            max_hp: 最大血量
            decision_type: 决策类型 ('fsm'|'bt'|'utility')
        """
        ...
        self.attack_cooldown_remaining: int = 0
        self.heal_cooldown_remaining: int = 0
        self.guard_position: Optional[Vector2] = None


class Enemy(Character):
    """敌人类"""
    
    def __init__(self, name: str = "Enemy", position: Vector2 = Vector2(0, 0), max_hp: float = 80.0):
        """初始化敌人
